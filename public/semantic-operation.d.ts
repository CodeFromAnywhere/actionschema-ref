...
/**
 * Input is a simplified object of what goes into the HTTP request to execute the operation.
 */
...
/**
 * Output is a simplified version of what comes out of the HTTP Response of the operation.
 */
