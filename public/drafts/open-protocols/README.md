'Open Protocol Sepcifications (OPS)' (for the lack of a better word) are OpenAPI Specifications that are to be adopted as a standardised variant of your common use-case.
